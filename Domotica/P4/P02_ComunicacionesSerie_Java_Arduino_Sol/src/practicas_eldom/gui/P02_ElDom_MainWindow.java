...
public class P02_ElDom_MainWindow {
	...
	public P02_ElDom_MainWindow() {		
      ...
      //display date time to status bar
		...
		JLabel lblSeleccionaApartadoPrctica = new JLabel("Selecciona modo de funcionamiento\r\n");
			...
			public void actionPerformed(ActionEvent e) {
				try {
					switch (comboBox.getSelectedIndex()) {
						...
						case 4: // Pulsadores funcionan como interruptores
							commSerie.writeStringToSerial("#5");
							break;
	
						case 5: // Todos los pulsadores forman parte de un conmutador.
							commSerie.writeStringToSerial("#6");
							break;
						case 6:
							commSerie.writeStringToSerial("#7");
							break;
	
						case 7: // Pulsadores funcionan como interruptores
							commSerie.writeStringToSerial("#8");
							break;
					}
