...
void config_practica1_apt_4(void){
	domoboard.BOTON1.SensorEvent = rele_pulsador;

	domoboard.BOTON2.SensorEvent = rele_pulsador;

	domoboard.BTN_OPT.SensorEvent = rele_pulsador;
}
