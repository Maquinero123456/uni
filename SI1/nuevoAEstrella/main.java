...
public class main {
	...
	public static void main(String[] args) {
		double obstaculos = 60*80*0.3;
		int obstaculos2 = (int) obstaculos;
		Malla a1 = new Malla(80, 60, 80, obstaculos2);
		boolean[][] problema1= a1.generarMatriz();
		System.out.println("MALLA "+1);
		EstadoMalla problemon= new EstadoMalla(a1.getXf(), a1.getYf(), problema1, a1.getXi(), a1.getYi());
		EstadoMalla estadoFinal= new EstadoMalla(a1.getXi(), a1.getYi());
		AgenteA ag1 = new AgenteA();
		System.out.println("\n");
		List<Estado> solucion = ag1.resuelve(problemon, estadoFinal);
		solucion.remove(solucion.size()-1);
		solucion.remove(0);
		List<String[]> solucionString = new ArrayList<>();
		for(Estado e : solucion){
			String[] a = e.toString().substring(1, e.toString().length()-1).split(", ");
			solucionString.add(a);
		}
		a1.printearProblema(ag1.matrizSolucion(solucionString, a1.ver(problema1)));
